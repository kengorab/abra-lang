...
fn typechecker_tests() {
    TestRunner::typechecker_test_runner()
        ...
        .add_test_vs_txt("typechecker/unary_error_minus.1.abraa", "typechecker/unary_error_minus.1.out")
        .add_test_vs_txt("typechecker/unary_error_minus.2.abra", "typechecker/unary_error_minus.2.out")
        .add_test_vs_txt("typechecker/unary_error_negat.1.abra", "typechecker/unary_error_neg.1.out")
