...
fn typechecker_tests() {
    TestRunner::typechecker_test_runner()
        ...
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.1.abra", "typechecker/funcdecl_default_param_value_call.1.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.2.abra", "typechecker/funcdecl_default_param_value_call.2.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.3.abra", "typechecker/funcdecl_default_param_value_call.3.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.4.abra", "typechecker/funcdecl_default_param_value_call.4.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.5.abra", "typechecker/funcdecl_default_param_value_call.5.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.6.abra", "typechecker/funcdecl_default_param_value_call.6.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.7.abra", "typechecker/funcdecl_default_param_value_call.7.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.8.abra", "typechecker/funcdecl_default_param_value_call.8.out.json")
        .add_test_vs_txt("typechecker/funcdecl_default_param_value_call.9.abra", "typechecker/funcdecl_default_param_value_call.9.out.json")
        // Returns
