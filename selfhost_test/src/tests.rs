...
fn typechecker_tests() {
    TestRunner::typechecker_test_runner()
        ...
        .add_test_vs_file("typechecker/bindingdecl/error_uninitialized_val.1.abra", "typechecker/bindingdecl/error_uninitialized_val.1.out")
        .add_test_vs_file("typechecker/bindingdecl/error_uninitialized_val.2.abra", "typechecker/bindingdecl/error_uninitialized_val.2.out")
